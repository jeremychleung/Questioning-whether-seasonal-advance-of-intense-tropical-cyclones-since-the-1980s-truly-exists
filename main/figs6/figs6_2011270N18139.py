...
for i,isid in enumerate(tc_sids):
    ...
    for k in range(2):
        ax = axs[k]
        ax.text(-0.10,1.06,chr(99+k), transform=ax.transAxes, fontdict={'weight':'bold','size':17})

        m = Basemap(llcrnrlon=105.,llcrnrlat=10,urcrnrlon=145.,urcrnrlat=33.33,projection='mill',\
